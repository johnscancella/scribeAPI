  ...
  render: ->
    ...
    <div className="subject-set-toolbar">
      ...
      <div className="subject-set-toolbar-links">
        ...
        <a className={if @props.hideOtherMarks == true then 'fa-toggle-on fa-2x' else 'fa-toggle-off fa-2x' } onClick={@props.toggleHideOtherMarks}><div className="helper">{if @props.hideOtherMarks == false then "Hide Marks of Other People" else "Showing Only Your Marks"}</div></a>
      </div>
    </div>
